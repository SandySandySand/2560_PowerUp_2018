 ...
 *
 */
public class RightStationAutoSOLS extends CommandGroup 
{

    public RightStationAutoSOLS() 
    {
		...
		addSequential(new Turn(90)); //turns 90 degrees
		addSequential(new DriveForwardEncoder(90, 0.8)); //drives to edge of switch
		addSequential(new Turn(90)); //turns 90 degrees
